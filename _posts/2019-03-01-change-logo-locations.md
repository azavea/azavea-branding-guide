...
## Clarifying changes
The separation between "Products" and "Open Source" projects was more confusing than helpful, and some Azavea projects were incorrectly located (for example, Climate API was on the Open Source page but isn’t open source). Brand information for the two pages has been consolidated for simplicity.
